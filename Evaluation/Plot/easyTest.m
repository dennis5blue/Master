...
schedulingMetric = [28.9598 29.4865 30.0372 30.4781 30.7630 31.1287 31.4953];
...
% Plot PSNR
figure(1);
plot(time,crossEntropy,'^-','LineWidth',2,'DisplayName','Cross entropy algorithm','Color','r','MarkerSize',10); hold on;
%plot(time,greedySNR,'^-','LineWidth',2,'DisplayName','Greedy with correlation','Color','r','MarkerSize',10); hold on;
plot(time,schedulingMetric,'^-','LineWidth',2,'DisplayName','Trellis with scheduling metric','Color','g','MarkerSize',10); hold on;
plot(time,trellis,'*-','LineWidth',2,'DisplayName','Trellis based algorithm','Color','b','MarkerSize',10);
