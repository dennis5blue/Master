function [ profit ] = CalProfitDividedByTxTime( imgPath, next, sched, unsched, numCams, reg, vecTxTime )
    ...
    for i = 1:length(unsched)
        ...
        if cam ~= next
            ...
            corrMatrix = load([imgPath 'mat/corrMatrix_' num2str(cam) '_' num2str(next) '.mat'],'corrMatrix');
            ...
            for j = 1:length(sched)
                ...
                tempCorrMat = load([imgPath 'mat/corrMatrix_' num2str(cam) '_' num2str(schedCam) '.mat'],'corrMatrix');
