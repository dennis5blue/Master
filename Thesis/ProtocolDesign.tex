...
\includegraphics[width=0.95\columnwidth]{Figures/txRoundExample.pdf}
...
Figure~\ref{fig::txRoundExample} gives an example of how video frames are scheduled within one transmission round.
...
\end{align}
Besides, we also denote $\bar{\eta}$ as the long term improvement ratio of all cameras, which is updated by a weighted sum procedure at the end of every transmission rounds.
...
\end{figure}
%
As a summary, we show the overall proposed system architecture in figure~\ref{fig::overallArchitecture}.