...
To proceed, since whether a camera $i$ can overhear the transmission of camera $j$ or not depends on the transmission schedule (can only overhear previous transmissions).
