...
# filename = "/home/dennisyu/Documents/Master/TopologyGen/cameraAtInter2.py"
...
#city radius = 5000m
cameraPos = (2.73, -2.72, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*290.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (2.73, -2.72, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*300.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (2.73, -2.72, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*310.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (2.73, -2.72, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*320.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (2.73, -2.72, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*330.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);

cameraPos = (-2.29, -0.99, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*220.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.29, -0.99, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*230.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.29, -0.99, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*240.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.29, -0.99, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*250.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.29, -0.99, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*260.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);

cameraPos = (0.84, 2.54, 0.2)
...
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.04, 1.42, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*270.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
cameraPos = (-2.04, 1.42, 0.2)
cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*280.0/180)
bpy.ops.object.camera_add(view_align=False, enter_editmode=False, location=cameraPos, rotation=cameraRotation);
...
c=1;
logFileName="/home/dennisyu/Documents/Master/SourceData/test3_png/log.txt"
...
# Find cameras that match cameraNames 
    if ( obj.type =='CAMERA'): 
        ...
        RR = "Render Result";
        bpy.data.images[RR].save_render("/home/dennisyu/Documents/Master/SourceData/test3_png/camera_"+str(c)+".png");
        c = c + 1; 
