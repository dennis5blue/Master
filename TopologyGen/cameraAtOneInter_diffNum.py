...
# filename = "/home/dennisyu/Documents/Master/TopologyGen/cameraAtOneInter_diffNum.py"
...
#add camera
#Note that AoV of each camera := 50 (degree) -> 8 cameras can cover the whole intersection
#city radius = 500m
camRotate = 45.0
startCamDir = 100.0
for nn in range(8):
	camDir = startCamDir + nn*camRotate
	cameraPos = (-0.3, -1.18, 0.2)
	cameraRotation = (math.pi*70.0/180, math.pi*0.0/180, math.pi*camDir/180)
...
c=1;
logFileName="/home/dennisyu/Documents/Master/SourceData/test13/log.txt"
...
# Find cameras that match cameraNames 
    if ( obj.type =='CAMERA'): 
        ...
        RR = "Render Result";
        bpy.data.images[RR].save_render("/home/dennisyu/Documents/Master/SourceData/test13/camera_"+str(c)+".png");
        c = c + 1; 
