This is the document for generating correlation matrix

 1. Execute the blender python script (cameraOnRoad.py) and get the test sequence, and log.txt
	Saved in ../SourceData/test_png
