function [improveRatio_real] = SAselection_geometricTemp (in_ifSave,in_numCams,in_testVersion,in_searchRange,in_overRange,in_iterLimit)
    %clc;
    %clear;
    ...
    SA_INIT_TEMP = 100;
    SA_FIN_TEMP = 0.01;
    SA_COOL_PARAM = (SA_FIN_TEMP/SA_INIT_TEMP)^(1/iterLimit);
    SA_ADD = 5000;
    SA_DISCARD = 30000;
    ...
    while iter < iterLimit
        ...
        SA_CURR_TEMP = SA_INIT_TEMP*(SA_COOL_PARAM^iter);
    ...
    if ifSaveFile == 1
        saveFileName = ['mat/SA/SAselectionGuidedGeoTemp_test' in_testVersion '_cam' num2str(N) '_rng' in_searchRange '_rho' in_overRange '_iter' in_iterLimit '.mat'];
        save(saveFileName);
    end
end