...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\texorpdfstring{\Makeuppercase{CHAbstract}}{CHAbstract}}
\chapter*{{\CJKfamily{bkai}\fontsize{16pt}{30pt}摘要}}
\vskip 0.5in
\fontsize{12pt}{50pt}\input{abstractCH.tex}
\clearpage\end{CJK*}
\begin{abstract}
\input{abstract.tex}
\end{abstract}
